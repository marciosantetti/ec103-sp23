---
title: ".b[International trade & globalization, pt. 2]"
...
.b[Required readings]:
  ...
  - [`OpenStax, ch. 10`](https://openstax.org/books/principles-macroeconomics-3e/pages/10-introduction-to-the-international-trade-and-capital-flows)
...
.b[Required watching]:
  ...
  - [`IMF Institute Learning Channel: Exchange rate regimes`](https://www.youtube.com/watch?v=4xcEfd35XRU)
...
<br>
  ...
  - When money .hi[flows out] of a country, these operations receive a *negative* sign.
  
  - When money .hi[flows into] a country, these operations receive a *positive* sign.
