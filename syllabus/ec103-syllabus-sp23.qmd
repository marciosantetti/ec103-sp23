---
title: "**EC 103--003: Introduction to Macroeconomics**"
...
\begin{tabular}{ll|l} 
	\textbf{When:} & \multicolumn{2}{l}{Mo 11:15 AM--12:10 PM \& WeFr 10:10 AM--11:30 AM} \\
	\textbf{Where:} & \multicolumn{2}{l}{Bolton 382 (\href{https://www.skidmore.edu/directions/maps.php}{\texttt{map}})} \\
	...
	\textbf{Web:} & \, \faPencil \, \href{https://github.com/marciosantetti/ec103-sp23/blob/main/README.md}{\texttt{Course GitHub Repository}} \\
\end{tabular}
...
This course covers basic terminologies, models, and problems in modern Macroeconomics. How does the macroeconomy work? What theories encapsulate the main macroeconomic variables? How can macroeconomic information be treated and presented in an informative way? These are some of the questions lectures will cover, providing students with theoretical and empirical tools to critically analyze real (macro)economic phenomena.

Wednesday and Friday (*WeFr*) meetings will cover the programmed content, in a lecture/discussion format. Monday (*Mo*) sessions will follow a "flipped classroom" model, dedicated to treating, analyzing, and visualizing macroeconomic data. There is no full understanding of macroeconomic events without data, and this course will address this issue.

# Course Content Organization

Lecture notes, assignments, and videos will be posted on the Course's [`GitHub repository`](https://github.com/marciosantetti/ec103-sp23/blob/main/README.md). Students are strongly recommended to bookmark this page, as it will be constantly updated throughout the semester. Additional readings, answer keys, and data files will be uploaded to `theSpring`. Students will also use `theSpring` to submit all assignments.
...
Monday sessions (*Mo*) will explore empirical tools to study macroeconomic data, and we will make use of $\textsf{R}$, an open-source and completely *free* statistical/programming language, with the $\textsf{R}$Studio IDE (Integrated Development Environment), also freely available. 
...
This course will have **no exams**. Instead, we will work through several assignments throughout the semester:
  ...
  - *Online Quizzes*, covering each topic studied in class (made available as soon as we finish each topic);

  - Four (4) *Problem Sets*, in which students will work out specific concepts studied in class;
  
  - Ten (10) *Lab Practices*, short assignments covering content from video lectures;
...
* ***May 11***: Submit last Mini Project by 12:00 PM
...
\begin{center}
 \textit{WeFr sessions}  |  \textit{Mo sessions} 
\end{center}
...
* **Week 2**:  The macroeconomic perspective |  Introduction to $\textsf{R}$ and $\textsf{R}$Studio

* **Week 3**:  The anatomy of GDP |  Manipulating data in the `tidyverse` 

* **Week 4**:  Economic growth |  Computing economic aggregates

* **Week 5**:  Unemployment I |  Data visualization: The "grammar of graphics"

* **Week 6**:  Unemployment II |  Data visualization: Making plots informative

* **Week 7**:  Inflation I |  Data visualization: Customizing and saving plots

* **Week 8**:  Inflation II |  Dealing with dates

* **Week 9**: International trade I  |  Variable classes

* **Week 10**:  International trade II |  Beautiful tables with `gt`

* **Week 11**:  Aggregate expenditures and multiplier effects I  |  Navigating the last Mini Project

* **Week 12**: Aggregate expenditures and multiplier effects II   |  Interactive plots with `plotly` 

* **Week 13**: Open-economy macroeconomics  |  Mini Project 3 Q&A I 

* **Week 14**:  Final thoughts and course wrap-up     |   Mini Project 3 Q&A II
